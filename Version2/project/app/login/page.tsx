...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (
      (formData.email === 'admin@gmail.com' && formData.password === 'admin') ||
      (formData.email === 'user@gmail.com' && formData.password === 'user')
    ) {
      // Store user type in localStorage
      const userType = formData.email === 'admin@gmail.com' ? 'admin' : 'user';
